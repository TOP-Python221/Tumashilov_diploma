...
INSERT INTO "new__products" ("id", "name", "price", "availability", "image", "category_id", "discount") SELECT "id", "name", "price", "availability", "image", "category_id", coalesce("discount", 0) FROM "products";
DROP TABLE "products";
